...
## sample-ec2 (Terraform plan to create an EC2 instance and a Security Group in AWS)

### Prerequisites

- I recommend working in the us-east-1 region.
- Create a Key Pair for EC2 instance with this structure: `"${lower(var.project)}-${lower(var.environment)}-kp"`
